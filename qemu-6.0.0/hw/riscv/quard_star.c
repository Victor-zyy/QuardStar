...
static PFlashCFI01
*quard_star_flash_create(RISCVVirtState *s, const char *name, const char *alias_prop_name)
{
...
static void quard_star_machine_init(MachineState *machine)
{
    ...
    for (i = 0; i < riscv_socket_count(machine); i++) {
        ...
        plic_hart_config_len =(strlen(QUARD_STAR_PLIC_HART_CONFIG) + 1) * hart_count;
